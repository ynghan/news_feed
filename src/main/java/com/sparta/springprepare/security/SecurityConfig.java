    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.headers((headers) ->
                headers.frameOptions(HeadersConfigurer
                        .FrameOptionsConfig::disable)); // iframe 허용안함
        http.csrf(AbstractHttpConfigurer::disable); // enable 이면 postman 작동안됨(메타코 유튜브의 시큐리티 강의)
        http.cors((cors) ->
        ...
        // 권한 실패
        http.exceptionHandling((exceptionHandling) -> exceptionHandling.accessDeniedHandler((request, response, e) -> {
