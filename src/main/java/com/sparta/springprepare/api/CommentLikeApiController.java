...
public class CommentLikeApiController {
    ...
    public ResponseEntity<?> pushLikeToComment(@PathVariable(name="commentId") Long commentId, @AuthenticationPrincipal UserDetailsImpl userDetails) {

        CommentLikeDto commentLikeDto = commentLikeService.pushLikeToComment(commentId, userDetails.getUser());
    ...
    public ResponseEntity<?> deleteLikeToComment(@PathVariable(name="commentId") Long commentId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        CommentLikeDto commentLikeDto = commentLikeService.deleteLikeToComment(commentId, userDetails.getUser());
