...
public class PostApiController {
    ...
    // 로그인 사용자 게시물 조회하기
    @GetMapping("/posts")
    public List<PostRespDto> getPosts(@AuthenticationPrincipal UserDetailsImpl userDetails) {
        // 응답 보내기
    ...
    public List<PostRespDto> getUserPosts(@PathVariable(name="followUsername") String followUsername, @AuthenticationPrincipal UserDetailsImpl userDetails) {
